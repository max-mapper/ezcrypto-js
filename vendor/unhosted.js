...
unhosted = new function() {
	...
	this.RSASign = function(sHashHex, pub, priv) {//this function copied from the rsa.js script included in Tom Wu's jsbn library
	...
	this.checkPubSign = function(cmd, PubSign, nick_n) {//check a signature. based on rsa-sign.js. uses Tom Wu's jsbn library.
